DELIMITER //
DROP PROCEDURE IF EXISTS reverse_momentum_get_net_earnings //
CREATE PROCEDURE reverse_momentum_get_net_earnings(IN loops int)
BEGIN

-- variables for ReverseMomentum table
...
DECLARE cur1 CURSOR FOR
    ...
    FROM F17336Pteam6.ReverseMomentum
...
-- open loop and go through ReverseMomentum, sell any existing holdings
open cur1;
   quote_loop: LOOP
